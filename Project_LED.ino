...
/*====================[Connecting to MQTT]====================*/
 ...
 void StartMQTT () {
    ...
    if (client.connect(MQTT::Connect("ESP8266_LED").set_auth(mqtt_user, mqtt_pass))) {
        client.set_callback(callback);
        client.subscribe("LED/SelectTopic");
...
void FillLEDsFromPaletteColors( uint8_t colorIndex){
    ...
    for (int i = 0; i < NUM_LEDS; i++) {
        leds[i] = ColorFromPalette( currentPalette, colorIndex, MidleBR, currentBlending);
        colorIndex += 3;
    }    
}
...
void loop() {
    ...
    switch (selector){
        case 0: Off();                              break;
        case 1: Nightlight();                       break;
        case 2: Rainbow();                          break;
        case 3: one_HEX_color_all( 0x6f56a3 ,true); break;
        case 4: Dots();                             break;  
    }
